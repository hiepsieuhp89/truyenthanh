    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            {{-- <li><div style="padding: 10px;">
                <select style="padding: 0;height: 30px;" class="form-control" name="language" id="lg_selection">
                    <option value="vn"@if(Session::get('lan') == 'vn') selected @endif >Tiếng việt</option>
                    <option value="en"@if(Session::get('lan') == 'en') selected @endif >Tiếng anh</option>
                </select>
                </div>
            </li> --}}
        </ul>
