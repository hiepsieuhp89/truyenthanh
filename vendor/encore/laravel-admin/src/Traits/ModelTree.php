...
trait ModelTree
{
     ...
     * @return array
     */
    protected function buildSelectOptions(array $nodes = [], $parentId = 0, $prefix = '', $space = "_")
    {
        $prefix = $prefix ?: '┝'.$space;
        ...
        foreach ($nodes as $index => $node) {
            if ($node[$this->parentColumn] == $parentId) {
                ...
                $childrenPrefix = str_replace('┝', str_repeat($space, 4), $prefix).'┝'.str_replace(['┝', $space], '', $prefix);
